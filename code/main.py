...
selected_class = [i for i in range(10)]
img_size = 64

# initialize the dataset, we can choose among 'FGVCAIRCRAFT','Flowers102','StanfordCars','MNIST', 'CIFAR10'
dataset = Dataset('CIFAR10', (img_size,img_size), selected_class = selected_class, grayscale = False)
...
diffusion.sample_plot_image(epoch = 'final', desired_class = None, custom_entry = None)
